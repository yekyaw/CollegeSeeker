...
public class Profile extends SherlockFragment {
    ...
    Spinner stateSpinner, sortSpinner;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        b.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Integer ver = parseInt(verView.getText().toString());
                Integer mat = parseInt(matView.getText().toString());
                Integer wri = parseInt(wriView.getText().toString());
                Integer act = parseInt(actView.getText().toString());
                while (cursor.moveToNext()) {
                    ...
                    if (CollegeHelper.isGoodMatch(college_small.isChecked(), college_medium.isChecked(), college_large.isChecked(),
                            ...
                            ver, mat, wri, act, college)) colleges.add(college);
                }
                cursor.close();
